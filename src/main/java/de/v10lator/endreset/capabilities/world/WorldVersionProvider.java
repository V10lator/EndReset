...
public class WorldVersionProvider implements ICapabilitySerializable<NBTBase> {

	@CapabilityInject(IWorldVersion.class)
	public static final Capability<IWorldVersion> VERSION_CAP = null;
	
	private IWorldVersion instance = VERSION_CAP.getDefaultInstance();
